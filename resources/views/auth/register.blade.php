...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2 p-auth__static">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="p-auth__static form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <div class="form-group p-auth__static">
                            <div class="col-md-6 col-md-offset-4 p-auth__static">
